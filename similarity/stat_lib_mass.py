...
def cal_inter_mass(ase_xyz,mda_xyz,fn,mesh=1.5, alpha=2.5, level=None):
    """
...
def analyze_single(idx,ase_xyz,mda_xyz, project_axis,solid_center0=-1,alpha = 2.5,plot=True,verbose=False, debug=False, assert_chi = True):
    ...
    inter, k,ase_a,mda_a = cal_inter_mass(ase_xyz,mda_xyz,idx,mesh=1., alpha=alpha, level=None)
