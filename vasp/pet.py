...
commands = {'p':"grep 'total pressure' OUTCAR | awk '{print $4}' > p.dat",
            ...
            'toten' :  "grep 'free  energy' OUTCAR | awk '{print $(NF-1)}' > toten.dat" ,# modify bc/ vasp6.3 ML energy #'toten' :  "grep 'free  energy   TOTEN' OUTCAR | awk '{print $5}' > toten.dat" ,
            'ewithout':"grep 'energy  without entropy' OUTCAR | awk -F '=' '{print $2}'| awk '{print $1}' >e.dat", # modify bc/ vasp6.3 ML energy  #'ewithout' : "grep 'energy  without entropy' OUTCAR | awk '{print $4}' >e.dat",
